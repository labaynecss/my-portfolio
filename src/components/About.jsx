...
export const About = () => {
  return (
    <section id="about" className=" bg-white   ">
      <motion.div className="container  mx-auto mt-[40rem] md:mt-[45rem] sm:mt-[60rem] mb-[5rem] ">
        ...
        <div className="flex flex-col md:flex-row md:gap-24">
          ...
          <div className="flex-1 flex flex-col justify-center items-center md:items-start md:text-left">
            <motion.div
              ...
              <motion.p className="mb-8 text-center sm:text-left  text-lg md:text-3xl  text-gray-700">
